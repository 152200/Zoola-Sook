...
import main_img from '../../images/gucci1.jpg'
import one_img from '../../images/gucci1.jpg'
import two_img from '../../images/gucci1.jpg'
import three_img from '../../images/gucci1.jpg'
import four_img from '../../images/gucci1.jpg'
                              ...
                              <Row>
                                   ...
                                   <Col className="p-3 " md={6} lg={6} sm={12} xs={12}>
                                        ...
                                        <div className="input-group mt-3">
                                             <button className="btn site-btn m-1 "> <i className="fa fa-shopping-cart"></i>  أضف إلى السلة </button>
                                             <button className="btn btn-success m-1"> <i className="fa fa-car"></i> اطلبه الآن </button>
                                             <button className="btn btn-secondary m-1"> <i className="fa fa-heart"></i> الإضافة إلى المفضلة </button>
                                        </div>
                                   </Col>
                              </Row>
                              <Row>
